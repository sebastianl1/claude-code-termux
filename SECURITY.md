...
Claude Code para Termux descarga y ejecuta el binario oficial de Claude Code
...
- Version de Claude Code/install.sh afectada.
...
responsabilidad. El binario de Claude Code pertenece a sus autores originales.
